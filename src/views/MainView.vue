...
export default {
    ...
    methods:{
        ...
        async getTodolist(id) {
            const res = await fetch(`http://82.64.190.33:3000/api/todo/list/${id}`)
        ...
        async createNewList() {
            ...
            const response = await fetch(`http://82.64.190.33:3000/api/todo/list/create`, {
                method: 'POST',
                headers: {
        ...
        async deleteList() {
            ...
            const response = await fetch(`http://82.64.190.33:3000/api/todo/list/delete/${id}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
                },
        ...
        async createItem() {
            ...
            const value = document.getElementById("txtItemName").value;
            const response = await fetch(`http://82.64.190.33:3000/api/todo/item/create`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
        ...
        async deleteItem(id) {
            const response = await fetch(`http://82.64.190.33:3000/api/todo/item/delete/${id}`, {
                method: "DELETE",
                headers: {
                    "Content-Type": "application/json",
                },
        ...
        async getItemsList(id) {
            const res = await fetch(`http://82.64.190.33:3000/api/todo/item/${id}`)
            const data = await res.json()
            this.items = data
            localStorage.setItem("list_id", data[0].group_id)
            this.list_name = data[0].todo_groups.todo_name
            this.list_desc = data[0].todo_groups.todo_desc
            document.getElementById("itemsMenu").classList.remove("invisible");
            document.getElementById("optionsMenu").classList.remove("invisible");
        },
        async checkboxItemClicked(id) {
            const checkbox = document.getElementById(`checkbox${id}`)
            const status = checkbox.checked ? 1 : 0
            const response = await fetch(`http://82.64.190.33:3000/api/todo/item/update/status`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    data() {
        return {
            todolist: this.getTodolist(localStorage.getItem("id")),
            items: [[]],
            list_name: [],
            list_desc: [],
        }
...
<template>
  ...
  >
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navcol-1">
        ...
        <span class="navbar-text mx-3">Welcome {{ user }} !</span
        ><button
  ...
  <section class="py-2 py-md-5 my-2">
    <div class="container py-md-5">
      <div class="row">
        <div class="col-md-6 col-lg-3 text-center">
          <h2 class="display-6 fw-bold text-center">
            <span class="underline pb-1">To Do Lists</span>
          </h2>
          <hr />
          <a
            data-bs-toggle="modal"
            ...
            title="If you need to create a new ToDo list."
        ...
        >
          <h2 class="display-6 fw-bold text-center">
            <span class="underline pb-1">Settings<br /></span>
          </h2>
          <hr />
          <div class="row">
            <div class="col">
              <div class="dropdown text-center" style="margin-bottom: 15px">
                <button
  ...
  <footer>
    <div class="container py-4 py-lg-5">
      ...
      >
        <p class="mb-0">Copyright © 2022 TodoListing</p>
